...
export default function Home(props) {
  ...
  return (
    <Fragment>
      <Head>
        <title>Akshay Rai</title>
        <meta name="title" content="Akshay Rai" />
        <meta property="og:title" content="Akshay Rai" />
        <meta property="twitter:title" content="Akshay Rai" />
      </Head>
      {!initialized && (
          ...
          <div className="flex flex-col items-start justify-start w-full space-y-3 md:space-y-6">
            <div className="flex flex-col items-start justify-start w-full space-y-3 md:space-y-6">
              ...
              <div className="flex flex-col items-start justify-start w-full space-y-3 md:space-y-4 max-w-2xl">
                ...
                >
                  I'm Akshay Rai, a 20 year old BTech student at VIT Vellore, self-motivated tech
                ...
                >
                  ...
                  stacks like React, Next, NodeJS, Typescript, MongoDB and
                  SQL. I've worked on plenty of projects including REST
                  APIs, Websites, CLIs and Discord Bots. I'm currently focusing
                  on participating in developer friendly events, hackathons and
                  looking for internships to gain real world experience.
                </motion.p>
              </div>
            </div>
            <motion.div
