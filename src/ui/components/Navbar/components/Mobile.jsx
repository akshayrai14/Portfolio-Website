      ...
      <div className="flex md:hidden flex-col items-start justify-start w-[90%] py-5 space-y-8">
        <div className="flex flex-col items-start justify-start w-full space-y-4">
          <div className="flex flex-row items-center justify-between w-full">
            <p className="text-xl text-white text-opacity-70">AkshayRai</p>
            <i
...
function Twitter() {
  return (
    <a
      target="_blank"
      href="https://www.linkedin.com/in/akshay-rai-5b21a3223/"
...
function GitHub() {
  return (
    <a
      target="_blank"
      href="https://github.com/akshayrai14"
      className="text-white text-opacity-70 hover:text-opacity-90 transition duration-300"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
function Mail() {
  return (
    <a
      target="_blank"
      href="mailto:akshay11rai@gmail.com"
      className="text-white text-opacity-70 hover:text-opacity-90 transition duration-300"
    >
      <svg
        width="30"
